"""
Vector store module for investment banking RAG bot.
...
class VectorStore:
    ...
    def __init__(
        ...
        index_name: str = None,
        namespace: str = None,
        dimension: int = 768  # Default for Gemini embeddings
    ):
        """
        ...
        Args:
            ...
            namespace: Namespace within the index (defaults to config)
    ...
    def upsert_items(self, items: List[Dict[str, Any]]) -> bool:
        ...
        Args:
            items: List of items with 'id', 'text', and 'embedding'
