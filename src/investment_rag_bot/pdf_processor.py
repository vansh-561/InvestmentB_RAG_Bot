"""
PDF processing module for investment banking RAG bot.
...
class PDFProcessor:
    ...
    def chunk_text(self, text: str) -> List[Dict[str, Any]]:
        ...
        with tqdm(total=estimated_chunks, desc="Creating chunks") as pbar:
            while start < text_length:
                ...
                if start <= chunks[-1]['start_char'] and len(chunks) > 0:
    ...
    def process_pdf(self, pdf_path: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if file_size_mb > 10:
                print("Large PDF detected. Reducing chunk size for better performance.")
